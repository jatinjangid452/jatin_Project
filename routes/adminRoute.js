...
admin_route.get('/home',auth.isLogin,adminController.loadDasboard);
...
admin_route.post('/edit-user',adminController.updatetUser);
admin_route.get('/delete-user',adminController.deleteUser);
// admin_route.post('/edelete-user',adminController.updatetUser);
